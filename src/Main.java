...
public static void main(String[] args)
    {
        ...
        Album album2 = new Album("Arijit's","Arijit Singh") ;
        album2.addSongtoAlbum("Kesariya",5.0);
        //album2.addSongtoAlbum(("Deva Deva",5.0);
        album2.addSongtoAlbum("Gerua",4.5);
        album2.addSongtoAlbum("Apna Bana le",6.0);
    ...
    public static void printMenu(){
        ...
        System.out.println("2 - Play revious song");
